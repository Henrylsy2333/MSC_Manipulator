...
#define ECERR_LOAD_RTX_LIB                     (-28) // Load RTX library failed
#define ECERR_READ_ENI_ERROR                   (-29) // Parser ENI failed, Please check ENI file
#define ECERR_EC_NIC_NOT_FOUND                 (-30) // Scan NIC for ESC not found.
#define ECERR_RT_DATA_BUFFER                   (-31) // Data length to large, data buferr overflow.
#define ECERR_MASTER_TYPE_CHECK                (-32) // This API doesn't support target master (runtime)type
#define ECERR_VERSION_NOT_SUPPORTED            (-33) // The version of target system is too old, please update the software to support this API
#define ECERR_INVALID_INPUT                    (-34) // Invalid input, please check input value.
#define ECERR_DATA_BUFFER_TOO_LARGE            (-35) // The size of data buffer which specified pointer to is too large
