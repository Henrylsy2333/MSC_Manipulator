...
Public Class MainForm
    ...
    Private Sub Button_Start_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button_Start.Click
        ...
        ret = NexECM.NEC_LoadRtxApp("C:\\Program Files\\NEXCOM\\NexECMRtx\\Samples\\RTX2016\\Sample_2Layer\\VS2015\\Sample2AxesControl_VBDotNET\\RtssDebug\\Sample2AxesControl_RTX.rtss")
        If ret <> 0 Then
            MessageBox.Show("NEC_LoadRtxApp" + ret.ToString)
            NexECM.NEC_StopDriver()
            Return
        End If
    ...
    Private Sub Timer1_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer1.Tick
        ...
        If data.SlaveState1 = 3 Then
            If data.SlaveState2 = 3 Then
                startcheck = 1
            End If
        End If

        If startcheck = 1 Then
            If data.SlaveState1 = 0 Then
                If data.SlaveState2 = 0 Then
