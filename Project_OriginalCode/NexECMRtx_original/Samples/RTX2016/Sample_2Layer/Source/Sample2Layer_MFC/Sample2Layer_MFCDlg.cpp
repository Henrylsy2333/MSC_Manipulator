...
void CSample2Layer_MFCDlg::OnBnClickedButtonStart()
{
	...
	ret = NEC_LoadRtxApp("C:\\Program Files\\NEXCOM\\NexECMRtx\\Samples\\RTX2016\\Sample_2Layer\\VS2015\\Sample2Layer_MFC\\RtssDebug\\Sample2Layer_RTX.rtss");
...
void CSample2Layer_MFCDlg::OnClose()
{
	...
	oBhandle3 = RtOpenEvent(NULL, 0, EVN_NAME3);
	if (oBhandle3 == NULL) { MessageBox("RtOpenEvent 3 failed "); return; }
	
	RtSetEvent(oBhandle3);
