...
namespace Sample2AexsControl
{
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            if (ret != 0) { MessageBox.Show("NEC_LoadRtxApp failed! error = ", Convert.ToInt32(ret).ToString()); this.Close(); return; }
        ...
        unsafe private void button_start_Click(object sender, EventArgs e)
        {
            ...
            ret = NexECM.NEC_LoadRtxApp("C:\\Program Files\\NEXCOM\\NexECMRtx\\Samples\\RTX2016\\Sample_2Layer\\VS2015\\Sample2AxesControl_C#\\RtssDebug\\Sample2AxesControl_RTX.rtss");
